...
class PortalViewManager : ReactViewManager(),
  ...
  override fun createViewInstance(context: ThemedReactContext): ReactViewGroup {
    return PortalView(context)
  }

  @ReactProp(name = "name")
  override fun setName(view: PortalView?, name: String?) {

  }

  @ReactProp(name = "hostName")
  override fun setHostName(view: PortalView?, name: String?) {
