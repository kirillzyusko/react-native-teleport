...
<Video src="/video/instagram.mp4" style={{ height: "50vh" }} />
...
<Video
  src="/video/instagram-no-shared-transition.mp4"
  style={{ height: "50vh" }}
  autoPlay={false}
  controls={true}
  loop={false}
...
<div className="center video" style={{ padding: "8px 0 24px" }}>
  <img
    src={useBaseUrl("/img/instagram-visualization.jpeg")}
    style={{ width: "100%", maxWidth: 960 }}
    alt="Illustrated lifecycle of the Instagram shared transition: tap a feed video, move it through the overlay into Reels, then reverse the same path back to the feed."
  />
</div>
