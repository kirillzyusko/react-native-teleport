...
This page describes the contract between [`Portal`](/react-native-teleport/pr-preview/pr-147/docs/api/components/portal.md) and [`PortalHost`](/react-native-teleport/pr-preview/pr-147/docs/api/components/portal-host.md) - what renders where, and how children move as components mount and unmount.
...
If you'd rather render *nothing* (or a different UI) while the host is missing instead of falling back locally, use the [`usePortal`](/react-native-teleport/pr-preview/pr-147/docs/api/hooks/use-portal.md) hook and read its `isHostAvailable` flag:
...
* [Portal API](/react-native-teleport/pr-preview/pr-147/docs/api/components/portal.md) - declarative component that teleports its children into a named host
* [PortalHost API](/react-native-teleport/pr-preview/pr-147/docs/api/components/portal-host.md) - the destination where teleported children are mounted
* [usePortal hook](/react-native-teleport/pr-preview/pr-147/docs/api/hooks/use-portal.md) - imperative access and `isHostAvailable` flag
* [Teleport guide](/react-native-teleport/pr-preview/pr-147/docs/guides/teleport.md) - for moving an *existing* view without unmounting it
