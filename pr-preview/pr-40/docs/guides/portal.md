...
![Portal helps to render a new view in a different container](/react-native-teleport/pr-preview/pr-40/assets/images/portal-2b20b94e26669e61959d937697ed6dde.png)
...
⚡ **Tip**: If you need to move an **existing** view (without unmounting/remounting), check out [Teleport](/react-native-teleport/pr-preview/pr-40/docs/guides/teleport.md) guide.
